...
export const product = [
  {
    ...
    cover: "../images/product/light.jpg",
    desc: "Why settle for an ordinary speaker when you can get your hands on the Amazon Echo Dot 4th Gen Alexa Built-in Smart Speaker online? Besides streaming millions of songs in practically all regional languages, the Echo Dot's brain – Alexa – can also answer trivia and give you the news, cricket scores, weather, recipes, set alarms, and even pay your bills. Your every wish is Alexa's command, and she can now understand English as well as Hindi! Ask Alexa to play your jam from Amazon Prime Music, JioSaavn, Gaana, Spotify, Apple Music, or Hungama Music, and groove to the premium-quality sound and deep bass of this Dolby-powered speaker.",
  },
  {
    id: 2,
    name: "Amazon",
    ...
    qty: 1,
    category: "website",
    cover: "../images/product/amazon.jpg",
  ...
  },
  {
    ...
    price: 40.0,
    qty: 1,
    category: "E;lectronic",
    cover: "../images/product/watch.jpg",
    desc: "The term cleanser refers to a product that cleans or removes dirt or other substances. A cleanser could be a detergent, and there are many types of cleansers that are produced with a specific objective or focus.",
  },
  {
    id: 4,
    ...
    cover: "../images/product/apple.jpeg",
    desc: "The term cleanser refers to a product that cleans or removes dirt or other substances. A cleanser could be a detergent, and there are many types of cleansers that are produced with a specific objective or focus.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    qty: 1,
    category: "Camera",
    cover: "../images/product/camera.jpeg",
    desc: "The term cleanser refers to a product that cleans or removes dirt or other substances. A cleanser could be a detergent, and there are many types of cleansers that are produced with a specific objective or focus.",
  },
  {
    id: 23,
    ...
    qty: 1,
    category: "Style",
    cover: "../images/product/shoes.jpeg",
    desc: "The term cleanser refers to a product that cleans or removes dirt or other substances. A cleanser could be a detergent, and there are many types of cleansers that are produced with a specific objective or focus.",
  },
  {
    id: 24,
